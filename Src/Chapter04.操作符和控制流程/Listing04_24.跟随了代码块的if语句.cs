 ...
 * 作者(Author)：Fowindy
 * 
 * 日期(Create Date)：2020年9月6日 星期日 07:44:44
 * 
 * 修改记录(Revision History)：
 *      R1：
 *          修改作者：Fowindy
 *          修改日期：2020年9月6日 星期日 07:44:44
 *          修改理由：创建文档
 * ==============================================================================*/
using System;
...
namespace Fowindy.Chapter04.操作符和控制流程.Listing04_24
{
    public class Listing04_24
    {
        public static void Main()
        {
            ...
            double area;//声明变量,存储面积
            double circumstance;//声明变量,存储周长
